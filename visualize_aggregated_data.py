...
top_merchants = pd.read_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_top_merchants.csv")
top_clients = pd.read_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_top_clients.csv")
transactions_by_state = pd.read_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_transactions_by_state.csv")
daily_trends = pd.read_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_daily_trends.csv")
avg_transaction_by_city = pd.read_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_avg_transaction_by_city.csv")
...
plt.tight_layout()
plt.savefig("/Users/saicharan/Desktop/MongoDB Big Data Project/top_10_merchants.png")
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("/Users/saicharan/Desktop/MongoDB Big Data Project/top_10_clients.png")
plt.show()
...
plt.tight_layout()
plt.savefig("/Users/saicharan/Desktop/MongoDB Big Data Project/transactions_by_state.png")
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("/Users/saicharan/Desktop/MongoDB Big Data Project/daily_trends.png")
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("/Users/saicharan/Desktop/MongoDB Big Data Project/avg_transaction_by_city.png")
plt.show()
