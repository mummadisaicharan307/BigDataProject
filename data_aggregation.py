...
top_merchants.to_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_top_merchants.csv", index=False)
top_clients.to_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_top_clients.csv", index=False)
transactions_by_state.to_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_transactions_by_state.csv", index=False)
daily_trends.to_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_daily_trends.csv", index=False)
avg_transaction_by_city.to_csv("/Users/saicharan/Desktop/MongoDB Big Data Project/agg_avg_transaction_by_city.csv", index=False)
